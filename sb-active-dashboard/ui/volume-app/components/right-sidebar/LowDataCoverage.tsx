...
export default function LowDataCoverage({ 
  ...
  // Don't show coverage warnings while data is still loading
  if (isLoading) {
    return null;
  }

  // Don't show "no data" message - let individual components handle their own no-data states
  // This component should only show data coverage warnings, not no-data states
